...
edit-image, plus Wan 2.2 I2V A14B image-to-video and TI2V 5B text-to-video. The
text-to-image pairs share one generic image topology. The
...
The Wan pairs use generic Diffusers video quantization, execution-recipe,
pipeline, generation, and export roles. I2V adds the generic image loader and
dual-transformer bindings; TI2V declares scheduler flow shift. Both keep
backend-declared native-flash, VAE-tiling, and frame-rate behavior.
