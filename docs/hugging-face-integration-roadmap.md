...
- [ ] **P0.3 Canonical execution-spec registry and generic node closure**
  ...
  - [ ] **P0.3e Remove remaining frontend and node model switches**
    ...
    - [ ] Move the remaining dynamic field visibility, guider/scheduler
      compatibility, readiness, and resource metadata out of frontend/node
      model switches and into reviewed declarative overlays.
