...
- [x] Admit Lumina Next and Lumina Image 2.0 text-to-image without claiming
  ...
  reserve with 39,195,086,276 bytes of headroom. A fresh exact app plan on
  2026-08-14 now reports all 16 Lumina Next files / 8,878,690,722 selected bytes
  complete at the immutable revision; its cache entry is installed, complete,
  and repair-free, while the app has advanced to Lumina Image 2.0. No older
  model was deleted and no media has been generated. Remote real-weight
  memory/output safety/quality review, model-snapshot license-file
  clarification, and physical macOS execution remain pending independently.
