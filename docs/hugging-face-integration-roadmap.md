...
- [ ] **P0.3 Canonical execution-spec registry and generic node closure**
  ...
  - [ ] **P0.3e Remove remaining frontend and node model switches**
    ...
    - [x] Exact-pair specification migration: all 39 currently declared
      ...
      overlays.
    - [ ] Move the remaining loader-component requirements, dynamic field
      visibility, layer allowlists, guider/scheduler compatibility, readiness,
      and resource metadata out of frontend/node model switches and into
      reviewed declarative overlays.
