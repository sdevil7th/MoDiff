...
- [ ] **P0.3 Canonical execution-spec registry and generic node closure**
  ...
  - [ ] **P0.3e Remove remaining frontend and node model switches**
    ...
    - [x] `WanVACEPipeline:video_inpaint`: backend and bundled-client commit
      ...
      readiness without a model-named production branch. Ownership is limited
      to `video_inpaint`; VACE outpaint and control-to-video remain unclaimed
      until their distinct conditioned-input contracts are migrated. The
