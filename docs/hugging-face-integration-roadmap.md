...
- [ ] **P0.3 Canonical execution-spec registry and generic node closure**
  ...
  - [ ] **P0.3e Remove remaining frontend and node model switches**
    ...
    - [ ] Audit and replace the remaining client presentation/resource
      ...
      backend adapter normalization explicit where they are the declared
      integration boundary rather than UI inference.
