...
- [ ] **P0.3 Canonical execution-spec registry and generic node closure**
  ...
  - [ ] **P0.3e Remove remaining frontend and node model switches**
    ...
    - [x] Loader-component requirement overlay. Backend commit `732e15c` adds a
      ...
      media occurred.
    - [ ] Move the remaining dynamic field visibility, layer allowlists,
      guider/scheduler compatibility, readiness, and resource metadata out of
