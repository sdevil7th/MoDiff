...
- [ ] **P0.3 Canonical execution-spec registry and generic node closure**
  ...
  - [ ] **P0.3e Remove remaining frontend and node model switches**
    ...
    - [x] `QwenImageEditModularPipeline:inpaint`: backend commit `de2160f`
      ...
      qualification occurred.
    - [x] `WanVACEPipeline:text_to_video`: backend commit `69a8561`
      ...
      `studio-spec-v1-b4b251f0`. Client commit `8f05541` proves that the
      ...
      model-named production branch. Ownership remains limited to
      text-to-video; VACE inpaint, outpaint, and control modes remain
      deliberately unclaimed until their distinct conditioned-input graphs
      are migrated. The focused backend matrix passed 188 tests with 360
