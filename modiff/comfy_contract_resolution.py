...
_PINNED_SOURCE_REVIEWS = {
    ...
    "comfy-research:template:video_wan_vace_outpainting": {
        "assetPath": "templates/video_wan_vace_outpainting.json",
        "assetSha256": "e811347b7fbccbae767192e1b3aa50312c1ad04df4090c9b3250788afe6e1ccc",
        "gitBlobOid": "e8a1a0c220c574452999eac37931c8450a301f23",
        "reviewedTaskMode": "video_outpaint",
        "reviewedOutputMediaKinds": ["video"],
        "reviewedWorkflowId": "WanVACEPipeline:video_outpaint",
        "artifactDependencies": [
        ...
        "comparison": {
            "state": "same_upstream_generation_different_partition_and_auxiliary",
            "currentWorkflowId": "WanVACEPipeline:video_outpaint",
            "currentRepository": "Wan-AI/Wan2.1-VACE-1.3B-diffusers",
            "currentRevision": "ec4d2cb062b548996b179d493fdd05340de702a1",
            "reasonCode": "wan_vace_14b_outpaint_partition_and_causvid_lora_not_admitted",
        },
        "resolutionState": "existing_family_workflow_candidate",
        "mappingMeaning": "source_reviewed_family_candidate_partition_and_auxiliary_exact_checkpoint_not_proven",
    },
    "comfy-research:template:video_wan_vace_inpainting": {
        "assetPath": "templates/video_wan_vace_inpainting.json",
        "assetSha256": "5c9ac91a991904294522cefe558da1230e77cc34968e9d1e1796bd234e9da42f",
        "gitBlobOid": "4af6c58919482553498d0e9f5bc7b5985030b914",
        "reviewedTaskMode": "video_inpaint",
        "reviewedOutputMediaKinds": ["video"],
        "reviewedWorkflowId": "WanVACEPipeline:video_inpaint",
        "artifactDependencies": [
            {"repository": "Comfy-Org/Wan_2.1_ComfyUI_repackaged", "artifact": "wan2.1_vace_14B_fp16.safetensors"},
            {"repository": "Kijai/WanVideo_comfy", "artifact": "Wan21_CausVid_14B_T2V_lora_rank32.safetensors"},
            {"repository": "Comfy-Org/Wan_2.1_ComfyUI_repackaged", "artifact": "umt5_xxl_fp8_e4m3fn_scaled.safetensors"},
        ...
        "comparison": {
            "state": "same_upstream_generation_different_partition_and_auxiliary",
            "currentWorkflowId": "WanVACEPipeline:video_inpaint",
            "currentRepository": "Wan-AI/Wan2.1-VACE-1.3B-diffusers",
            "currentRevision": "ec4d2cb062b548996b179d493fdd05340de702a1",
            "reasonCode": "wan_vace_14b_inpaint_partition_causvid_and_sam3_not_admitted",
        },
        "resolutionState": "existing_family_workflow_candidate",
        "mappingMeaning": "source_reviewed_family_candidate_partition_and_auxiliary_exact_checkpoint_not_proven",
    },
    "comfy-research:template:wan2.1_fun_inp": {
        "assetPath": "templates/wan2.1_fun_inp.json",
    ...
    "comfy-research:template:image_anima_lllite_image_inpainting": {
        ...
        "assetSha256": "b08730d127942d490222dfe1d7ae7746e7f951d9957cc988ceab83f31576cd5b",
        "gitBlobOid": "0fef38f42235bf9a6133f502a3f9611a8a4fdd3e",
        "reviewedWorkflowId": "ChromaInpaintPipeline:inpaint",
        "artifactDependencies": [
            {"repository": "circlestone-labs/Anima", "artifact": "qwen_3_06b_base.safetensors"},
            {"repository": "circlestone-labs/Anima", "artifact": "qwen_image_vae.safetensors"},
            {"repository": "circlestone-labs/Anima", "artifact": "anima-base-v1.0.safetensors"},
            {"repository": "Comfy-Org/Anima-LLLite", "artifact": "anima-lllite-inpainting-v2.safetensors"},
            {"repository": "circlestone-labs/Anima-Official-LoRAs", "artifact": "anima-turbo-lora-v0.2.safetensors"},
        ],
        "comparison": {
            "state": "different_model_generation_requires_admission",
            "currentWorkflowId": "ChromaInpaintPipeline:inpaint",
            "currentRepository": "lodestones/Chroma1-HD",
            "currentRevision": "0e0c60ece1e82b17cb7f77342d765ba5024c40c0",
            "reasonCode": "anima_lllite_inpaint_is_not_chroma1_hd",
        },
        "resolutionState": "existing_task_boundary_model_admission_required",
        "mappingMeaning": "source_reviewed_task_boundary_only_different_model_generation",
    },
    "comfy-research:template:template_ltx2_3_style_transition": {
        "assetPath": "templates/template_ltx2_3_style_transition.json",
        "assetSha256": "f62e95e49f0c12cea01a6b9e40d53038fdd0cea13bd37620b67954b91e88aaeb",
        "gitBlobOid": "020f494959a49fb0ddf6c84fd3827461452bbc0a",
        "reviewedTaskMode": "first_last_frame_to_video_with_audio",
        "reviewedOutputMediaKinds": ["video", "audio"],
        "artifactDependencies": [
            {"repository": "Lightricks/LTX-2.3-fp8", "artifact": "ltx-2.3-22b-distilled-fp8.safetensors"},
            {"repository": "Comfy-Org/ltx-2", "artifact": "gemma_3_12B_it_fp4_mixed.safetensors"},
            {"repository": "valiantcat/LTX-2.3-Transition-LORA", "artifact": "ltx2.3-transition.safetensors"},
        ],
        "comparison": {
            "state": "different_model_generation_and_new_task_required",
            "currentWorkflowId": None,
            "currentRepository": None,
            "currentRevision": None,
            "reasonCode": "ltx2_3_style_transition_requires_first_last_frame_video_audio_task_and_lora",
        },
        "resolutionState": "new_task_boundary_required",
        "mappingMeaning": "source_reviewed_new_first_last_frame_video_audio_task_and_model_generation_required",
    },
    "comfy-research:template:video_ltx2_3_flf2v": {
        "assetPath": "templates/video_ltx2_3_flf2v.json",
        "assetSha256": "168bc2584ef117133e76341f04e001aab2641b72b75d81b66b5c0b66e56c24a5",
        "gitBlobOid": "377ebd149ed9659a11d3828e922127ab10d55b04",
        "reviewedTaskMode": "first_last_frame_to_video_with_audio",
        "reviewedOutputMediaKinds": ["video", "audio"],
        "artifactDependencies": [
            {"repository": "Lightricks/LTX-2.3-fp8", "artifact": "ltx-2.3-22b-distilled-fp8.safetensors"},
        ...
        "comparison": {
            ...
            "currentRepository": None,
            "currentRevision": None,
            "reasonCode": "ltx2_3_first_last_frame_requires_synchronized_video_audio_task",
        },
        "resolutionState": "new_task_boundary_required",
        "mappingMeaning": "source_reviewed_new_first_last_frame_video_audio_task_and_model_generation_required",
    },
    "comfy-research:template:video_ltx2_5_flf2v": {
        "assetPath": "templates/video_ltx2_5_flf2v.json",
        "assetSha256": "8730ff8e5d014f7922e61a29f5a5417c3e64ce4fa00d6d066397b766e49c751f",
        "gitBlobOid": "7d6c2f0a84040baae602e8f7feb22074e236a4da",
        "reviewedTaskMode": "first_last_frame_to_video_with_audio",
        "reviewedOutputMediaKinds": ["video", "audio"],
        "artifactDependencies": [
        ...
        "comparison": {
            ...
            "currentRepository": None,
            "currentRevision": None,
            "reasonCode": "ltx2_5_first_last_frame_requires_synchronized_video_audio_task",
        },
        "resolutionState": "new_task_boundary_required",
        "mappingMeaning": "source_reviewed_new_first_last_frame_video_audio_task_and_model_generation_required",
    },
    "comfy-research:template:video_wan2_2_14B_flf2v": {
    ...
    "comfy-research:template:video_hunyuan_video_1.5_720p_i2v": {
        ...
        "assetSha256": "4f6ab488b60f7b70f6501217c1ed697a366f29c3c36755e87ef76f6023676015",
        ...
        "comparison": {
            ...
            "currentRepository": "Lightricks/LTX-2",
            "currentRevision": "47da56e2ad66ce4125a9922b4a8826bf407f9d0a",
            "reasonCode": "hunyuan_video_1_5_i2v_is_not_ltx2",
        },
        "resolutionState": "existing_task_boundary_model_admission_required",
        "mappingMeaning": "source_reviewed_task_boundary_only_different_model_generation",
    },
    "comfy-research:template:video_hunyuan_video_1.5_720p_t2v": {
        "assetPath": "templates/video_hunyuan_video_1.5_720p_t2v.json",
        "assetSha256": "b52ab35cd7f5253288d32ca2d18329607a0e5fb265886e234bae7b75deff8cfe",
        ...
        "comparison": {
            "state": "different_model_generation_requires_admission",
            "currentWorkflowId": "AllegroPipeline:text_to_video",
            "currentRepository": "rhymes-ai/Allegro",
            "currentRevision": "c1b9207bb5cb79e2aa08f3d139c17d26c0de55b6",
            "reasonCode": "hunyuan_video_1_5_t2v_is_not_allegro",
        },
        "resolutionState": "existing_task_boundary_model_admission_required",
        "mappingMeaning": "source_reviewed_task_boundary_only_different_model_generation",
    },
    "comfy-research:template:video_kandinsky5_i2v": {
        "assetPath": "templates/video_kandinsky5_i2v.json",
        "assetSha256": "a9207a2ad5742dd6dbe9d161c66cf540c6ff05b246fcac89f5d065761e5f4c65",
        "gitBlobOid": "84e93537567c9b074af50752d01ea94be1f72b10",
        "reviewedWorkflowId": "LTX2ConditionPipeline:image_to_video",
        "artifactDependencies": [
        ...
        "comparison": {
            ...
            "currentRepository": "Lightricks/LTX-2",
            "currentRevision": "47da56e2ad66ce4125a9922b4a8826bf407f9d0a",
            "reasonCode": "kandinsky5_i2v_is_not_ltx2",
        },
        "resolutionState": "existing_task_boundary_model_admission_required",
        "mappingMeaning": "source_reviewed_task_boundary_only_different_model_generation",
    },
    "comfy-research:template:video_kandinsky5_t2v": {
        "assetPath": "templates/video_kandinsky5_t2v.json",
        "assetSha256": "ff478d7601c1b27182bbc94e0a914321037ebd9643d3327c5968511f8a6cf9a4",
        ...
        "comparison": {
            ...
            "currentRepository": "rhymes-ai/Allegro",
            "currentRevision": "c1b9207bb5cb79e2aa08f3d139c17d26c0de55b6",
            "reasonCode": "kandinsky5_t2v_is_not_allegro",
        },
        "resolutionState": "existing_task_boundary_model_admission_required",
        "mappingMeaning": "source_reviewed_task_boundary_only_different_model_generation",
    },
    "comfy-research:template:hunyuan_video_text_to_video": {
        "assetPath": "templates/hunyuan_video_text_to_video.json",
        "assetSha256": "3f221fb9cb178bf4e186410553b918604751deb58f61e03bebbcee64721e8744",
        "gitBlobOid": "5dd529c76047163cbbc3ec976445956f10e867cd",
        "reviewedWorkflowId": "AllegroPipeline:text_to_video",
        "artifactDependencies": [
            {"repository": "Comfy-Org/HunyuanVideo_repackaged", "artifact": "hunyuan_video_t2v_720p_bf16.safetensors"},
            {"repository": "Comfy-Org/HunyuanVideo_repackaged", "artifact": "llava_llama3_fp8_scaled.safetensors"},
            {"repository": "Comfy-Org/HunyuanVideo_repackaged", "artifact": "hunyuan_video_vae_bf16.safetensors"},
            {"repository": "comfyanonymous/flux_text_encoders", "artifact": "clip_l.safetensors"},
        ],
        "comparison": {
            "state": "different_model_generation_requires_admission",
            ...
            "currentRepository": "rhymes-ai/Allegro",
            "currentRevision": "c1b9207bb5cb79e2aa08f3d139c17d26c0de55b6",
            "reasonCode": "hunyuan_video_t2v_is_not_allegro",
        },
        "resolutionState": "existing_task_boundary_model_admission_required",
        "mappingMeaning": "source_reviewed_task_boundary_only_different_model_generation",
    },
    "comfy-research:template:video_capybara_v0_1_image_to_video": {
        "assetPath": "templates/video_capybara_v0_1_image_to_video.json",
        "assetSha256": "9fa710ee75a352831f47e6aa36277bde3913daa57743de8c66915d8d6241cbbc",
        "gitBlobOid": "c02cacb9f876fa0fb934d3151511d070b3a9e382",
        "reviewedWorkflowId": "LTX2ConditionPipeline:image_to_video",
        "artifactDependencies": [
            {"repository": "Comfy-Org/HunyuanVideo_1.5_repackaged", "artifact": "capybara_v0.1.safetensors"},
        ...
        "comparison": {
            ...
            "currentRepository": "Lightricks/LTX-2",
            "currentRevision": "47da56e2ad66ce4125a9922b4a8826bf407f9d0a",
            "reasonCode": "capybara_video_i2v_is_not_ltx2",
        },
        "resolutionState": "existing_task_boundary_model_admission_required",
        "mappingMeaning": "source_reviewed_task_boundary_only_different_model_generation",
    },
    "comfy-research:template:video_capybara_v0_1_video_edit": {
        "assetPath": "templates/video_capybara_v0_1_video_edit.json",
        "assetSha256": "d202d82f4d0d89b5f19e50d00e37cec016e7b4bed06a8324be421f1972458e93",
        "gitBlobOid": "ded8c063e15f0173c65d94e41625eb6e29395c5d",
        "artifactDependencies": [
            {"repository": "Comfy-Org/HunyuanVideo_1.5_repackaged", "artifact": "capybara_v0.1.safetensors"},
            {"repository": "Comfy-Org/HunyuanImage_2.1_ComfyUI", "artifact": "qwen_2.5_vl_7b.safetensors"},
            {"repository": "Comfy-Org/HunyuanVideo_1.5_repackaged", "artifact": "byt5_small_glyphxl_fp16.safetensors"},
        ...
        "comparison": {
            ...
            "currentRepository": None,
            "currentRevision": None,
            "reasonCode": "capybara_requires_bounded_video_edit_task_and_model_generation",
        },
        "resolutionState": "new_task_boundary_required",
        "mappingMeaning": "source_reviewed_new_video_edit_task_and_model_generation_required",
    },
    "comfy-research:template:video_bernini_r_image_editing": {
        "assetPath": "templates/video_bernini_r_image_editing.json",
        "assetSha256": "fd002ed6f77274a46cfdfc1d379765647eca01882c62f3a1c41ce94ac9e2ccee",
        "gitBlobOid": "ca3d1c2a1981faa2322ae98ee0bfa85995b379c2",
        ...
        "comparison": {
            "state": "different_model_generation_requires_admission",
            "currentWorkflowId": "ChromaImg2ImgPipeline:edit_image",
            "currentRepository": "lodestones/Chroma1-HD",
            "currentRevision": "0e0c60ece1e82b17cb7f77342d765ba5024c40c0",
            "reasonCode": "bernini_r_image_edit_is_not_chroma1_hd",
        },
        "resolutionState": "existing_task_boundary_model_admission_required",
        "mappingMeaning": "source_reviewed_task_boundary_only_different_model_generation",
    },
    "comfy-research:template:video_bernini_r_video_editing": {
        "assetPath": "templates/video_bernini_r_video_editing.json",
        "assetSha256": "1af0f1ef82c211e0acdb0d726411b7e5e19b9468d785c507d1d9a64b241bf093",
        "gitBlobOid": "c9d3623d4049b986356e47bcbb112fd07040d765",
        "artifactDependencies": [
            {"repository": "Comfy-Org/Bernini-R", "artifact": "wan2.2_bernini_r_high_noise_fp8_scaled.safetensors"},
            {"repository": "Comfy-Org/Bernini-R", "artifact": "wan2.2_bernini_r_low_noise_fp8_scaled.safetensors"},
            {"repository": "Kijai/WanVideo_comfy", "artifact": "lightx2v_T2V_14B_cfg_step_distill_v2_lora_rank64_bf16.safetensors"},
        ...
        "comparison": {
            ...
            "currentRepository": None,
            "currentRevision": None,
            "reasonCode": "bernini_r_requires_bounded_video_edit_task_and_model_generation",
        },
        "resolutionState": "new_task_boundary_required",
        "mappingMeaning": "source_reviewed_new_video_edit_task_and_model_generation_required",
    },
    "comfy-research:template:txt_to_image_to_video": {
        "assetPath": "templates/txt_to_image_to_video.json",
        "assetSha256": "5f10394fa88508f80b45d1ff221a7a912054f2f0c74aef803096f1892b3e3fda",
        "gitBlobOid": "4c8a4894c1a2ae5fb35702880266fe2b57174e8b",
        "reviewedWorkflowId": "AllegroPipeline:text_to_video",
        "artifactDependencies": [
            {"repository": "stabilityai/stable-diffusion-xl-base-1.0", "artifact": "sd_xl_base_1.0.safetensors"},
            {"repository": "stabilityai/stable-video-diffusion-img2vid-xt", "artifact": "svd_xt.safetensors"},
        ],
        "comparison": {
            "state": "different_model_generation_requires_admission",
            "currentWorkflowId": "AllegroPipeline:text_to_video",
            "currentRepository": "rhymes-ai/Allegro",
            "currentRevision": "c1b9207bb5cb79e2aa08f3d139c17d26c0de55b6",
            "reasonCode": "sdxl_svd_two_stage_generation_is_not_allegro",
        },
        "resolutionState": "existing_task_boundary_model_admission_required",
        "mappingMeaning": "source_reviewed_task_boundary_only_different_model_generation",
    },
    "comfy-research:template:video_humo": {
        "assetPath": "templates/video_humo.json",
        "assetSha256": "4a8a18e27e216e4419fa0b8d812b881546afb243e1ac3fdb01c3097500768fba",
        "gitBlobOid": "c408a326b85c701e69146104ecc83f5cb89a291d",
        "reviewedTaskMode": "image_audio_to_video",
        "artifactDependencies": [
        ...
        "comparison": {
            ...
            "currentRepository": None,
            "currentRevision": None,
            "reasonCode": "humo_requires_image_audio_conditioned_video_task_and_model_generation",
        },
        "resolutionState": "new_task_boundary_required",
        "mappingMeaning": "source_reviewed_new_image_audio_video_task_and_model_generation_required",
    },
    "comfy-research:template:hidream_e1_1": {
        "assetPath": "templates/hidream_e1_1.json",
        "assetSha256": "855f61d4d34960aede887c6cda1d37ede8af881f043e66363da855882007e62e",
        "gitBlobOid": "b43bcca048e888b5f7f9d1b713a3465052924736",
        "reviewedWorkflowId": "ChromaImg2ImgPipeline:edit_image",
        "artifactDependencies": [
            {"repository": "Comfy-Org/HiDream-I1_ComfyUI", "artifact": "hidream_e1_1_bf16.safetensors"},
            {"repository": "Comfy-Org/HiDream-I1_ComfyUI", "artifact": "clip_g_hidream.safetensors"},
            {"repository": "Comfy-Org/HiDream-I1_ComfyUI", "artifact": "clip_l_hidream.safetensors"},
            {"repository": "Comfy-Org/HiDream-I1_ComfyUI", "artifact": "t5xxl_fp8_e4m3fn_scaled.safetensors"},
            {"repository": "Comfy-Org/HiDream-I1_ComfyUI", "artifact": "llama_3.1_8b_instruct_fp8_scaled.safetensors"},
            {"repository": "Comfy-Org/HiDream-I1_ComfyUI", "artifact": "ae.safetensors"},
        ],
        "comparison": {
            "state": "different_model_generation_requires_admission",
            "currentWorkflowId": "ChromaImg2ImgPipeline:edit_image",
            "currentRepository": "lodestones/Chroma1-HD",
            "currentRevision": "0e0c60ece1e82b17cb7f77342d765ba5024c40c0",
            "reasonCode": "hidream_e1_1_edit_is_not_chroma1_hd",
        },
        "resolutionState": "existing_task_boundary_model_admission_required",
        "mappingMeaning": "source_reviewed_task_boundary_only_different_model_generation",
    },
    "comfy-research:template:hidream_e1_full": {
        "assetPath": "templates/hidream_e1_full.json",
        "assetSha256": "05ac669b54e7a6c927918026d712e3b9ab4f6af485ff718df516211be7bb8035",
        "gitBlobOid": "057d62066a57cfa9639e81912c348743d8c6fcd9",
        "reviewedWorkflowId": "ChromaImg2ImgPipeline:edit_image",
        "artifactDependencies": [
            {"repository": "Comfy-Org/HiDream-I1_ComfyUI", "artifact": "hidream_e1_full_bf16.safetensors"},
            {"repository": "Comfy-Org/HiDream-I1_ComfyUI", "artifact": "clip_g_hidream.safetensors"},
            {"repository": "Comfy-Org/HiDream-I1_ComfyUI", "artifact": "clip_l_hidream.safetensors"},
            {"repository": "Comfy-Org/HiDream-I1_ComfyUI", "artifact": "t5xxl_fp8_e4m3fn_scaled.safetensors"},
            {"repository": "Comfy-Org/HiDream-I1_ComfyUI", "artifact": "llama_3.1_8b_instruct_fp8_scaled.safetensors"},
        ...
        "comparison": {
            ...
            "currentRepository": "lodestones/Chroma1-HD",
            "currentRevision": "0e0c60ece1e82b17cb7f77342d765ba5024c40c0",
            "reasonCode": "hidream_e1_full_edit_is_not_chroma1_hd",
        },
        "resolutionState": "existing_task_boundary_model_admission_required",
        "mappingMeaning": "source_reviewed_task_boundary_only_different_model_generation",
    },
    "comfy-research:template:hidream_i1_dev": {
        "assetPath": "templates/hidream_i1_dev.json",
        "assetSha256": "3e929f0cb81a126c36436a7e07d5a2d7b7a55e656f6392edfd4749e365cf87ea",
        "gitBlobOid": "7ae5db47050e8c47124525d7fc37f9ddb43e6a7f",
        "reviewedWorkflowId": "AuraFlowPipeline:text_to_image",
        "artifactDependencies": [
            {"repository": "Comfy-Org/HiDream-I1_ComfyUI", "artifact": "hidream_i1_dev_fp8.safetensors"},
            {"repository": "Comfy-Org/HiDream-I1_ComfyUI", "artifact": "clip_g_hidream.safetensors"},
            {"repository": "Comfy-Org/HiDream-I1_ComfyUI", "artifact": "clip_l_hidream.safetensors"},
            {"repository": "Comfy-Org/HiDream-I1_ComfyUI", "artifact": "t5xxl_fp8_e4m3fn_scaled.safetensors"},
            {"repository": "Comfy-Org/HiDream-I1_ComfyUI", "artifact": "llama_3.1_8b_instruct_fp8_scaled.safetensors"},
        ...
        "comparison": {
            "state": "different_model_generation_requires_admission",
            "currentWorkflowId": "AuraFlowPipeline:text_to_image",
            "currentRepository": "fal/AuraFlow-v0.3",
            "currentRevision": "2cd8588f04c886002be4571697d84654a50e3af3",
            "reasonCode": "hidream_i1_dev_is_not_auraflow",
        },
        "resolutionState": "existing_task_boundary_model_admission_required",
        "mappingMeaning": "source_reviewed_task_boundary_only_different_model_generation",
    },
    "comfy-research:template:hidream_i1_fast": {
        "assetPath": "templates/hidream_i1_fast.json",
        "assetSha256": "345400d918e9645f5328a329377cc7de3799fa102d696ed97ee897bdd2a9b7ee",
        "gitBlobOid": "60a6efb63511ac851359451dbd8641c4d71cccd9",
        "reviewedWorkflowId": "AuraFlowPipeline:text_to_image",
        "artifactDependencies": [
            {"repository": "Comfy-Org/HiDream-I1_ComfyUI", "artifact": "hidream_i1_fast_fp8.safetensors"},
            {"repository": "Comfy-Org/HiDream-I1_ComfyUI", "artifact": "clip_g_hidream.safetensors"},
            {"repository": "Comfy-Org/HiDream-I1_ComfyUI", "artifact": "clip_l_hidream.safetensors"},
            {"repository": "Comfy-Org/HiDream-I1_ComfyUI", "artifact": "t5xxl_fp8_e4m3fn_scaled.safetensors"},
            {"repository": "Comfy-Org/HiDream-I1_ComfyUI", "artifact": "llama_3.1_8b_instruct_fp8_scaled.safetensors"},
        ...
        "comparison": {
            ...
            "currentRepository": "fal/AuraFlow-v0.3",
            "currentRevision": "2cd8588f04c886002be4571697d84654a50e3af3",
            "reasonCode": "hidream_i1_fast_is_not_auraflow",
        },
        "resolutionState": "existing_task_boundary_model_admission_required",
        "mappingMeaning": "source_reviewed_task_boundary_only_different_model_generation",
    },
    "comfy-research:template:hidream_i1_full": {
        "assetPath": "templates/hidream_i1_full.json",
        "assetSha256": "af698df59699a8ec0659d2e5e60fe17b0b9a7d7cd70cd81fb007126f0a8d6a06",
        "gitBlobOid": "dce2b274d78ff175694761c1ad0c9962346e9cb0",
        "reviewedWorkflowId": "AuraFlowPipeline:text_to_image",
        "artifactDependencies": [
            {"repository": "Comfy-Org/HiDream-I1_ComfyUI", "artifact": "hidream_i1_full_fp8.safetensors"},
            {"repository": "Comfy-Org/HiDream-I1_ComfyUI", "artifact": "clip_g_hidream.safetensors"},
            {"repository": "Comfy-Org/HiDream-I1_ComfyUI", "artifact": "clip_l_hidream.safetensors"},
            {"repository": "Comfy-Org/HiDream-I1_ComfyUI", "artifact": "t5xxl_fp8_e4m3fn_scaled.safetensors"},
            {"repository": "Comfy-Org/HiDream-I1_ComfyUI", "artifact": "llama_3.1_8b_instruct_fp8_scaled.safetensors"},
        ...
        "comparison": {
            ...
            "currentRepository": "fal/AuraFlow-v0.3",
            "currentRevision": "2cd8588f04c886002be4571697d84654a50e3af3",
            "reasonCode": "hidream_i1_full_is_not_auraflow",
        },
        "resolutionState": "existing_task_boundary_model_admission_required",
        "mappingMeaning": "source_reviewed_task_boundary_only_different_model_generation",
    },
    "comfy-research:template:Image_capybara_v0_1_image_edit": {
        "assetPath": "templates/Image_capybara_v0_1_image_edit.json",
        "assetSha256": "80e31cca9d819d144a570c349c0d20abdf8c8ba0bf5be672db333af0cd3cb41b",
        "gitBlobOid": "a637f517e22c8a7b3c5e90d5148d0c29bd68dc50",
        "reviewedWorkflowId": "ChromaImg2ImgPipeline:edit_image",
        "artifactDependencies": [
            {"repository": "Comfy-Org/HunyuanVideo_1.5_repackaged", "artifact": "capybara_v0.1.safetensors"},
            {"repository": "Comfy-Org/HunyuanImage_2.1_ComfyUI", "artifact": "qwen_2.5_vl_7b.safetensors"},
        ...
        "comparison": {
            ...
            "currentRepository": "lodestones/Chroma1-HD",
            "currentRevision": "0e0c60ece1e82b17cb7f77342d765ba5024c40c0",
            "reasonCode": "capybara_image_edit_is_not_chroma1_hd",
        },
        "resolutionState": "existing_task_boundary_model_admission_required",
        "mappingMeaning": "source_reviewed_task_boundary_only_different_model_generation",
    },
    "comfy-research:template:Image_capybara_v0_1_text_to_image": {
        "assetPath": "templates/Image_capybara_v0_1_text_to_image.json",
        "assetSha256": "68d76c054291bf39a0fc3fd46bad4262f65763fe23543f0815239d2cad335846",
        "gitBlobOid": "53cc549f91350d6f146164aeda551a18219a6fe2",
        "reviewedWorkflowId": "AuraFlowPipeline:text_to_image",
        "artifactDependencies": [
            {"repository": "Comfy-Org/HunyuanVideo_1.5_repackaged", "artifact": "capybara_v0.1.safetensors"},
            {"repository": "Comfy-Org/HunyuanImage_2.1_ComfyUI", "artifact": "qwen_2.5_vl_7b.safetensors"},
        ...
        "comparison": {
            ...
            "currentRepository": "fal/AuraFlow-v0.3",
            "currentRevision": "2cd8588f04c886002be4571697d84654a50e3af3",
            "reasonCode": "capybara_image_generation_is_not_auraflow",
        },
        "resolutionState": "existing_task_boundary_model_admission_required",
        "mappingMeaning": "source_reviewed_task_boundary_only_different_model_generation",
    },
    "comfy-research:template:image_anima_base_v1": {
        "assetPath": "templates/image_anima_base_v1.json",
        "assetSha256": "f5d093bfb97409b5e3798394044baa8e775235335ffb881f0de0bf09a470cfe2",
        "gitBlobOid": "f572962bfa4aaecd0ee7721df58b03d684c11c9d",
        "reviewedWorkflowId": "AuraFlowPipeline:text_to_image",
        "artifactDependencies": [
            {"repository": "circlestone-labs/Anima", "artifact": "qwen_3_06b_base.safetensors"},
            {"repository": "circlestone-labs/Anima", "artifact": "qwen_image_vae.safetensors"},
        ...
        "comparison": {
            ...
            "currentRepository": "fal/AuraFlow-v0.3",
            "currentRevision": "2cd8588f04c886002be4571697d84654a50e3af3",
            "reasonCode": "anima_base_v1_is_not_auraflow",
        },
        "resolutionState": "existing_task_boundary_model_admission_required",
        "mappingMeaning": "source_reviewed_task_boundary_only_different_model_generation",
    },
    "comfy-research:template:image_anima_preview": {
        "assetPath": "templates/image_anima_preview.json",
        "assetSha256": "379c70f65677582ff8dd99ffe7da9595781a903d2b491ce55c47277c2a3918c4",
        "gitBlobOid": "f0bf84c0e8e9c0b2dc4634371626d8ae288fb289",
        "reviewedWorkflowId": "AuraFlowPipeline:text_to_image",
        "artifactDependencies": [
            {"repository": "circlestone-labs/Anima", "artifact": "qwen_3_06b_base.safetensors"},
            {"repository": "circlestone-labs/Anima", "artifact": "qwen_image_vae.safetensors"},
            {"repository": "circlestone-labs/Anima", "artifact": "anima-preview3-base.safetensors"},
        ],
        "comparison": {
            "state": "different_model_generation_requires_admission",
            "currentWorkflowId": "AuraFlowPipeline:text_to_image",
            "currentRepository": "fal/AuraFlow-v0.3",
            "currentRevision": "2cd8588f04c886002be4571697d84654a50e3af3",
            "reasonCode": "anima_preview_is_not_auraflow",
        },
        "resolutionState": "existing_task_boundary_model_admission_required",
        "mappingMeaning": "source_reviewed_task_boundary_only_different_model_generation",
    },
    "comfy-research:template:image_boogu_image_0_1_edit": {
        "assetPath": "templates/image_boogu_image_0_1_edit.json",
        "assetSha256": "3d4ef170006a9ce4c635bf9c00adfd95e5257a15013fcaa6e99196362df51522",
        "gitBlobOid": "c452dc0e1c831de8ea738b4e11a59dc7525d8238",
        "reviewedWorkflowId": "ChromaImg2ImgPipeline:edit_image",
        "artifactDependencies": [
            {"repository": "Comfy-Org/Boogu-Image", "artifact": "boogu_image_edit_fp8_scaled.safetensors"},
            {"repository": "Comfy-Org/HiDream-I1_ComfyUI", "artifact": "ae.safetensors"},
            {"repository": "Comfy-Org/Qwen3-VL", "artifact": "qwen3vl_8b_fp8_scaled.safetensors"},
        ],
        "comparison": {
            "state": "different_model_generation_requires_admission",
            "currentWorkflowId": "ChromaImg2ImgPipeline:edit_image",
            "currentRepository": "lodestones/Chroma1-HD",
            "currentRevision": "0e0c60ece1e82b17cb7f77342d765ba5024c40c0",
            "reasonCode": "boogu_image_edit_is_not_chroma1_hd",
        },
        "resolutionState": "existing_task_boundary_model_admission_required",
        "mappingMeaning": "source_reviewed_task_boundary_only_different_model_generation",
    },
    "comfy-research:template:image_boogu_image_0_1_edit_int8": {
        "assetPath": "templates/image_boogu_image_0_1_edit_int8.json",
        "assetSha256": "4467872eb6314d850f3f1bc33cb134c46cafcc232e8e89f5e6551a3801b01030",
        "gitBlobOid": "1d9cd1a0f28c76c74ad972c6ffd823aef11e84ea",
        "reviewedWorkflowId": "ChromaImg2ImgPipeline:edit_image",
        "artifactDependencies": [
            {"repository": "Comfy-Org/Boogu-Image", "artifact": "boogu_image_edit_int8_convrot.safetensors"},
            {"repository": "Comfy-Org/HiDream-I1_ComfyUI", "artifact": "ae.safetensors"},
            {"repository": "Comfy-Org/Qwen3-VL", "artifact": "qwen3vl_8b_fp8_scaled.safetensors"},
        ],
        "comparison": {
            ...
            "currentRepository": "lodestones/Chroma1-HD",
            "currentRevision": "0e0c60ece1e82b17cb7f77342d765ba5024c40c0",
            "reasonCode": "boogu_image_edit_int8_is_not_chroma1_hd",
        },
        "resolutionState": "existing_task_boundary_model_admission_required",
        "mappingMeaning": "source_reviewed_task_boundary_only_different_model_generation",
    },
    "comfy-research:template:image_boogu_image_0_1_turbo_t2i": {
        "assetPath": "templates/image_boogu_image_0_1_turbo_t2i.json",
        "assetSha256": "10d9b2d80a58c62148416746c622d54ee87bd8be02b261521486e16b9a00b28b",
        "gitBlobOid": "0386a9fccd5075d20de37c972bb29fcaeea95f8a",
        "reviewedWorkflowId": "AuraFlowPipeline:text_to_image",
        "artifactDependencies": [
            {"repository": "Comfy-Org/Boogu-Image", "artifact": "boogu_image_turbo_fp8_scaled.safetensors"},
            {"repository": "Comfy-Org/HiDream-I1_ComfyUI", "artifact": "ae.safetensors"},
            {"repository": "Comfy-Org/Boogu-Image", "artifact": "qwen3vl_8b_fp8_scaled.safetensors"},
        ],
        "comparison": {
            "state": "different_model_generation_requires_admission",
            "currentWorkflowId": "AuraFlowPipeline:text_to_image",
            "currentRepository": "fal/AuraFlow-v0.3",
            "currentRevision": "2cd8588f04c886002be4571697d84654a50e3af3",
            "reasonCode": "boogu_image_turbo_is_not_auraflow",
        },
        "resolutionState": "existing_task_boundary_model_admission_required",
        "mappingMeaning": "source_reviewed_task_boundary_only_different_model_generation",
    },
    "comfy-research:template:image_chrono_edit_14B": {
        "assetPath": "templates/image_chrono_edit_14B.json",
        "assetSha256": "b94f062db60f853fad10cd565cdd49dde387f2da49d0d24624947813f1d661b4",
        "gitBlobOid": "e354fb1ab91240f81458da367216b3ccd544fa03",
        "reviewedWorkflowId": "ChromaImg2ImgPipeline:edit_image",
        "artifactDependencies": [
        ...
        "comparison": {
            ...
            "currentRepository": "lodestones/Chroma1-HD",
            "currentRevision": "0e0c60ece1e82b17cb7f77342d765ba5024c40c0",
            "reasonCode": "chronoedit_wan_video_frame_edit_is_not_chroma_img2img",
        },
        "resolutionState": "existing_task_boundary_model_admission_required",
        "mappingMeaning": "source_reviewed_task_boundary_only_different_model_generation",
    },
    "comfy-research:template:image_firered_image_edit1_1": {
        "assetPath": "templates/image_firered_image_edit1_1.json",
        "assetSha256": "d31e091ef80748bd3d41f3cd3cd0970fe3f353acc1aee603f52324dd5d25f23c",
        ...
        "comparison": {
            ...
            "currentRepository": "lodestones/Chroma1-HD",
            "currentRevision": "0e0c60ece1e82b17cb7f77342d765ba5024c40c0",
            "reasonCode": "firered_image_edit_is_not_chroma_img2img",
        },
        "resolutionState": "existing_task_boundary_model_admission_required",
        "mappingMeaning": "source_reviewed_task_boundary_only_different_model_generation",
    },
    "comfy-research:template:image_ideogram4_t2i": {
        "assetPath": "templates/image_ideogram4_t2i.json",
        "assetSha256": "87dba0e3002b76990836a1ebbe43e0885175d2bcdbcd41e854d5bcd2209ea2dd",
        "gitBlobOid": "9c016c249246439ccc08ccffbab31d04e54673cb",
        "reviewedWorkflowId": "AuraFlowPipeline:text_to_image",
        "artifactDependencies": [
            {"repository": "Comfy-Org/Ideogram-4", "artifact": "ideogram4_fp8_scaled.safetensors"},
            {"repository": "Comfy-Org/Ideogram-4", "artifact": "ideogram4_unconditional_fp8_scaled.safetensors"},
            {"repository": "Comfy-Org/Qwen3-VL", "artifact": "qwen3vl_8b_fp8_scaled.safetensors"},
            {"repository": "Comfy-Org/flux2-dev", "artifact": "flux2-vae.safetensors"},
        ],
        "comparison": {
            ...
            "currentRepository": "fal/AuraFlow-v0.3",
            "currentRevision": "2cd8588f04c886002be4571697d84654a50e3af3",
            "reasonCode": "ideogram4_dual_model_generation_is_not_auraflow",
        },
        "resolutionState": "existing_task_boundary_model_admission_required",
        "mappingMeaning": "source_reviewed_task_boundary_only_different_model_generation",
    },
    "comfy-research:template:image_ideogram4_t2i_int8": {
        "assetPath": "templates/image_ideogram4_t2i_int8.json",
        "assetSha256": "a85346f5ad1ab07dcaf8bbd99f6618a26dbd46c11fb13128680822fe9dd880c4",
        "gitBlobOid": "4e9a71db38bc0c6e09aafba658adb5b06d10c8fa",
        "reviewedWorkflowId": "AuraFlowPipeline:text_to_image",
        "artifactDependencies": [
            {"repository": "Comfy-Org/Ideogram-4", "artifact": "ideogram4_int8_convrot.safetensors"},
            {"repository": "Comfy-Org/Ideogram-4", "artifact": "ideogram4_unconditional_int8_convrot.safetensors"},
            {"repository": "Comfy-Org/Qwen3-VL", "artifact": "qwen3vl_8b_fp8_scaled.safetensors"},
            {"repository": "Comfy-Org/flux2-dev", "artifact": "flux2-vae.safetensors"},
        ],
        "comparison": {
            ...
            "currentRepository": "fal/AuraFlow-v0.3",
            "currentRevision": "2cd8588f04c886002be4571697d84654a50e3af3",
            "reasonCode": "ideogram4_int8_dual_model_generation_is_not_auraflow",
        },
        "resolutionState": "existing_task_boundary_model_admission_required",
        "mappingMeaning": "source_reviewed_task_boundary_only_different_model_generation",
    },
    "comfy-research:template:image_krea2_turbo_t2i": {
        "assetPath": "templates/image_krea2_turbo_t2i.json",
        "assetSha256": "d04b37d8345b1bf6aa247ef182a4454e0221730cf353379af27b20e932e9f11f",
        "gitBlobOid": "74f3d6e07214fc3ded1a31170a5ca5198761339c",
        "reviewedWorkflowId": "AuraFlowPipeline:text_to_image",
        "artifactDependencies": [
            {"repository": "Comfy-Org/Krea-2", "artifact": "krea2_turbo_fp8_scaled.safetensors"},
            {"repository": "Comfy-Org/Krea-2", "artifact": "krea2_darkbrush.safetensors"},
            {"repository": "Comfy-Org/Krea-2", "artifact": "qwen3vl_4b_fp8_scaled.safetensors"},
            {"repository": "Comfy-Org/Krea-2", "artifact": "qwen_image_vae.safetensors"},
        ],
        "comparison": {
            "state": "different_model_generation_requires_admission",
            "currentWorkflowId": "AuraFlowPipeline:text_to_image",
            "currentRepository": "fal/AuraFlow-v0.3",
            "currentRevision": "2cd8588f04c886002be4571697d84654a50e3af3",
            "reasonCode": "krea2_turbo_is_not_auraflow",
        },
        "resolutionState": "existing_task_boundary_model_admission_required",
        "mappingMeaning": "source_reviewed_task_boundary_only_different_model_generation",
    },
    "comfy-research:template:image_krea2_turbo_t2i_int8": {
        "assetPath": "templates/image_krea2_turbo_t2i_int8.json",
        "assetSha256": "6207dcc9849a6e000240783ceabb4d3050bb941f469b85529217ea88002e1b83",
        "gitBlobOid": "59a58337dfa8d5f43b036102b8888bc74ff43531",
        "reviewedWorkflowId": "AuraFlowPipeline:text_to_image",
        "artifactDependencies": [
            {"repository": "Comfy-Org/Krea-2", "artifact": "krea2_turbo_int8_convrot.safetensors"},
            {"repository": "Comfy-Org/Krea-2", "artifact": "krea2_darkbrush.safetensors"},
            {"repository": "Comfy-Org/Krea-2", "artifact": "qwen3vl_4b_fp8_scaled.safetensors"},
            {"repository": "Comfy-Org/Krea-2", "artifact": "qwen_image_vae.safetensors"},
        ],
        "comparison": {
            ...
            "currentRepository": "fal/AuraFlow-v0.3",
            "currentRevision": "2cd8588f04c886002be4571697d84654a50e3af3",
            "reasonCode": "krea2_turbo_int8_is_not_auraflow",
        },
        "resolutionState": "existing_task_boundary_model_admission_required",
        "mappingMeaning": "source_reviewed_task_boundary_only_different_model_generation",
    },
    "comfy-research:template:image_lens_t2i": {
        "assetPath": "templates/image_lens_t2i.json",
        "assetSha256": "4c20b9a5cc65711b79a322dcd858291f2beedd0285648e65e5c9171f3045a49a",
        "gitBlobOid": "e12d2d791d212cc8aed8ee00d9999d25206a866b",
        "reviewedWorkflowId": "AuraFlowPipeline:text_to_image",
        "artifactDependencies": [
            {"repository": "Comfy-Org/Lens", "artifact": "lens_bf16.safetensors"},
            {"repository": "Comfy-Org/Lens", "artifact": "gpt_oss_20b_nvfp4.safetensors"},
            {"repository": "Comfy-Org/Lens", "artifact": "flux2-vae.safetensors"},
        ],
        "comparison": {
            "state": "different_model_generation_requires_admission",
            "currentWorkflowId": "AuraFlowPipeline:text_to_image",
            "currentRepository": "fal/AuraFlow-v0.3",
            "currentRevision": "2cd8588f04c886002be4571697d84654a50e3af3",
            "reasonCode": "lens_generation_is_not_auraflow",
        },
        "resolutionState": "existing_task_boundary_model_admission_required",
        "mappingMeaning": "source_reviewed_task_boundary_only_different_model_generation",
    },
    "comfy-research:template:image_lens_turbo_t2i": {
        "assetPath": "templates/image_lens_turbo_t2i.json",
        "assetSha256": "7d326a952112f62e5ddca2bd2b70afb0fd56aebba115db0d128d37eb4dd0de41",
        "gitBlobOid": "604a4ba02cd10dc7d00703cf1975151ee6787c45",
        "reviewedWorkflowId": "AuraFlowPipeline:text_to_image",
        "artifactDependencies": [
            {"repository": "Comfy-Org/Lens", "artifact": "lens_turbo_bf16.safetensors"},
            {"repository": "Comfy-Org/Lens", "artifact": "gpt_oss_20b_nvfp4.safetensors"},
            {"repository": "Comfy-Org/Lens", "artifact": "flux2-vae.safetensors"},
        ],
        "comparison": {
            ...
            "currentRepository": "fal/AuraFlow-v0.3",
            "currentRevision": "2cd8588f04c886002be4571697d84654a50e3af3",
            "reasonCode": "lens_turbo_generation_is_not_auraflow",
        },
        "resolutionState": "existing_task_boundary_model_admission_required",
        "mappingMeaning": "source_reviewed_task_boundary_only_different_model_generation",
    },
    "comfy-research:template:image_mage_flow_edit_int8": {
        "assetPath": "templates/image_mage_flow_edit_int8.json",
        "assetSha256": "5469829111f45490297e19197d0765e4c84abce231dd32252f7c375931f7c9ab",
        "gitBlobOid": "312fc5be121f9f1923177909358f9cf19feecfbc",
        "reviewedWorkflowId": "ChromaImg2ImgPipeline:edit_image",
        "artifactDependencies": [
            {"repository": "Comfy-Org/Mage-Flow", "artifact": "mage_flow_edit_int8_convrot.safetensors"},
            {"repository": "Comfy-Org/Mage-Flow", "artifact": "qwen3vl_4b_bf16.safetensors"},
            {"repository": "Comfy-Org/Mage-Flow", "artifact": "mage_flow_vae_bf16.safetensors"},
        ],
        "comparison": {
            "state": "different_model_generation_requires_admission",
            "currentWorkflowId": "ChromaImg2ImgPipeline:edit_image",
            "currentRepository": "lodestones/Chroma1-HD",
            "currentRevision": "0e0c60ece1e82b17cb7f77342d765ba5024c40c0",
            "reasonCode": "mage_flow_edit_int8_is_not_chroma_img2img",
        },
        "resolutionState": "existing_task_boundary_model_admission_required",
        "mappingMeaning": "source_reviewed_task_boundary_only_different_model_generation",
    },
    "comfy-research:template:image_mage_flow_edit_turbo_int8": {
        "assetPath": "templates/image_mage_flow_edit_turbo_int8.json",
        "assetSha256": "b7b4d0ab9a180578eddd6772439f8baa6b6edfcb226d6c04e577a67291363a2f",
        "gitBlobOid": "4eb258f83f99f1f0929d9105e06840c21c49e2cf",
        "reviewedWorkflowId": "ChromaImg2ImgPipeline:edit_image",
        "artifactDependencies": [
            {"repository": "Comfy-Org/Mage-Flow", "artifact": "mage_flow_edit_turbo_int8_convrot.safetensors"},
            {"repository": "Comfy-Org/Mage-Flow", "artifact": "qwen3vl_4b_bf16.safetensors"},
            {"repository": "Comfy-Org/Mage-Flow", "artifact": "mage_flow_vae_bf16.safetensors"},
        ],
        "comparison": {
            ...
            "currentRepository": "lodestones/Chroma1-HD",
            "currentRevision": "0e0c60ece1e82b17cb7f77342d765ba5024c40c0",
            "reasonCode": "mage_flow_edit_turbo_int8_is_not_chroma_img2img",
        },
        "resolutionState": "existing_task_boundary_model_admission_required",
        "mappingMeaning": "source_reviewed_task_boundary_only_different_model_generation",
    },
    "comfy-research:template:image_mage_flow_t2i_int8": {
        "assetPath": "templates/image_mage_flow_t2i_int8.json",
        "assetSha256": "1f8ff2932fa38d7b2b0abca4f97ee71297b60ae4978be7f10130c2929781ba77",
        "gitBlobOid": "e03ee35484c548078018993e8205972960be9236",
        "reviewedWorkflowId": "AuraFlowPipeline:text_to_image",
        "artifactDependencies": [
            {"repository": "Comfy-Org/Mage-Flow", "artifact": "mage_flow_int8_convrot.safetensors"},
            {"repository": "Comfy-Org/Mage-Flow", "artifact": "qwen3vl_4b_bf16.safetensors"},
            {"repository": "Comfy-Org/Mage-Flow", "artifact": "mage_flow_vae_bf16.safetensors"},
        ],
        "comparison": {
            ...
            "currentRepository": "fal/AuraFlow-v0.3",
            "currentRevision": "2cd8588f04c886002be4571697d84654a50e3af3",
            "reasonCode": "mage_flow_int8_is_not_auraflow",
        },
        "resolutionState": "existing_task_boundary_model_admission_required",
        "mappingMeaning": "source_reviewed_task_boundary_only_different_model_generation",
    },
    "comfy-research:template:image_mage_flow_turbo_t2i_int8": {
        "assetPath": "templates/image_mage_flow_turbo_t2i_int8.json",
        "assetSha256": "80430a53af34d7eeca50e662a921f5dae8f210a617f4d31300177925a0c6cd76",
        "gitBlobOid": "b44d44f2b584a195e093581633c065772332b90b",
        "reviewedWorkflowId": "AuraFlowPipeline:text_to_image",
        "artifactDependencies": [
            {"repository": "Comfy-Org/Mage-Flow", "artifact": "mage_flow_int8_convrot.safetensors"},
            {"repository": "Comfy-Org/Mage-Flow", "artifact": "qwen3vl_4b_bf16.safetensors"},
        ...
        "comparison": {
            ...
            "currentRepository": "fal/AuraFlow-v0.3",
            "currentRevision": "2cd8588f04c886002be4571697d84654a50e3af3",
            "reasonCode": "catalog_turbo_graph_loads_unadmitted_mage_flow_int8_generation",
        },
        "resolutionState": "existing_task_boundary_model_admission_required",
        "mappingMeaning": "source_reviewed_task_boundary_only_different_model_generation",
    },
    "comfy-research:template:image_newbieimage_exp0_1-t2i": {
        "assetPath": "templates/image_newbieimage_exp0_1-t2i.json",
        "assetSha256": "111b57ebbc5c06f0b107cfb463d9e726f786d085131dcfbe2caa7f4c030c12fb",
        ...
        "comparison": {
            ...
            "currentRepository": "fal/AuraFlow-v0.3",
            "currentRevision": "2cd8588f04c886002be4571697d84654a50e3af3",
            "reasonCode": "newbie_image_generation_is_not_auraflow",
        },
        "resolutionState": "existing_task_boundary_model_admission_required",
        "mappingMeaning": "source_reviewed_task_boundary_only_different_model_generation",
    },
    "comfy-research:template:image_pixeldit_t2i": {
        "assetPath": "templates/image_pixeldit_t2i.json",
        "assetSha256": "fa7d853f130f517252752b51c2bc1167aaee56847d8ffd338a01a01615eee713",
        "gitBlobOid": "61d7236d058ddbcf921b544ffdfcf6afe7108cda",
        "reviewedWorkflowId": "AuraFlowPipeline:text_to_image",
        "artifactDependencies": [
            {"repository": "Comfy-Org/PixelDiT", "artifact": "pixeldit_1300m_1024px_bf16.safetensors"},
            {"repository": "Comfy-Org/PixelDiT", "artifact": "gemma_2_2b_it_elm_bf16.safetensors"},
            {"repository": "Comfy-Org/ComfyUI", "artifact": "pixel_space VAE implementation"},
        ],
        "comparison": {
            "state": "different_model_generation_requires_admission",
            "currentWorkflowId": "AuraFlowPipeline:text_to_image",
            "currentRepository": "fal/AuraFlow-v0.3",
            "currentRevision": "2cd8588f04c886002be4571697d84654a50e3af3",
            "reasonCode": "pixeldit_pixel_space_generation_is_not_auraflow",
        },
        "resolutionState": "existing_task_boundary_model_admission_required",
        "mappingMeaning": "source_reviewed_task_boundary_only_different_model_generation",
    },
    "comfy-research:template:sd3.5_large_blur": {
        "assetPath": "templates/sd3.5_large_blur.json",
        "assetSha256": "f239d7ed9e66e8e8f3a10664bed4050e7252ca64d5b81175883a2664d989bb30",
        "gitBlobOid": "f64f7dc0850042f2abcf11424795494f2a286387",
        "reviewedTaskMode": "control_image",
        ...
        "comparison": {
            "state": "different_model_generation_requires_admission",
            "currentWorkflowId": "StableDiffusionPipeline:control_image",
            "currentRepository": "stable-diffusion-v1-5/stable-diffusion-v1-5",
            "currentRevision": "451f4fe16113bff5a5d2269ed5ad43b0592e9a14",
            "reasonCode": "sd35_blur_controlnet_is_not_sd15_canny_controlnet",
        },
        "resolutionState": "existing_task_boundary_model_admission_required",
        "mappingMeaning": "source_reviewed_task_boundary_only_different_model_generation",
    },
    "comfy-research:template:sd3.5_simple_example": {
        "assetPath": "templates/sd3.5_simple_example.json",
        "assetSha256": "22636f8ea8d35f41ecf92917112e14376bc30ae2c01de0b9553493cf2c176619",
        "gitBlobOid": "48b081dfb8be8995718e9e6a1b3e49bb9f7852d1",
        "reviewedWorkflowId": "AuraFlowPipeline:text_to_image",
        "artifactDependencies": [
            {"repository": "Comfy-Org/stable-diffusion-3.5-fp8", "artifact": "sd3.5_large_fp8_scaled.safetensors"},
        ],
        "comparison": {
            ...
            "currentRepository": "fal/AuraFlow-v0.3",
            "currentRevision": "2cd8588f04c886002be4571697d84654a50e3af3",
            "reasonCode": "sd35_large_generation_is_not_auraflow",
        },
        "resolutionState": "existing_task_boundary_model_admission_required",
        "mappingMeaning": "source_reviewed_task_boundary_only_different_model_generation",
    },
