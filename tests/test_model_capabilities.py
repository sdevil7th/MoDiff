...
class ModelCapabilitiesTests(unittest.IsolatedAsyncioTestCase):
    async def test_capabilities_publish_normalized_execution_contract(self):
        ...
        self.assertEqual(len(payload["studioExecutionSpecs"]), 28)
        for model_type in (
            "FluxSchnellPipeline",
            "FluxDevPipeline",
            "FluxKreaPipeline",
        ...
        self.assertEqual(wan_vace["studioExecutionSpecModes"], ["text_to_video"])
        wan_vace_text_spec = wan_vace["studioExecutionSpecs"][0]
